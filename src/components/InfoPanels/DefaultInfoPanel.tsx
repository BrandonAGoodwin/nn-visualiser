...
function DefaultInfoPanel() {
    ...
    return (
        <div>
            ...
            <p>
                This is a tool that lets you play with a simple neural network implementation. Below are instructions on how to get started designing your own neural network and test it's performance.
                <ul>
                    <li>There are some exercises to help show the effects of certain hyper-parameters that can be acces via the <b>info buttons</b> <Info fontSize={"small"} /> (e.g. batch size exercise and learning rate exercise).</li>
