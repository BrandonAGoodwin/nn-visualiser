...
function LearningRateInfoPanel(props: LearningRateInfoPanelProps) {
    ...
    return (
        <div style={{ float: "left"}}>
            ...
            <p>Try running a dozen epochs with the preset learning rate and save the state using the <b>Save</b> <SaveIcon fontSize={"small"} /> button, then <b>increase or decrease the learning rate to see how the learning rate effects the training performance</b> using the <b>loss graph</b>.</p>
            <h2>Observations</h2>
            <p>
