...
function BatchSizeInfoPanel(props: BatchSizeInfoPanelProps) {
    ...
    return (
        <div style={{ float: "left", maxWidth: "80%" }}>
            ...
            <p>
                Try running a couple dozen epochs of training with the preset batch size and save the state using the <b>Save</b> <SaveIcon fontSize={"small"} /> button, then <b>change the batch size to see how the batch size affects the training performance</b> using the <b>loss graph</b>.
            </p>
